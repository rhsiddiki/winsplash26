    ...
    <div className="w-full max-w-7xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-blue-600/20 border border-blue-500/30 text-blue-300 text-xs font-bold uppercase tracking-[0.2em] mb-2">
          ...
          SESSION 05 • COMMERCIAL & BUSINESS GROWTH
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white/5 p-2 rounded-2xl border border-white/10 backdrop-blur-md">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {activeView === 'retained' ? 'Back to Commercial Stats' : 'Commercial Retained Pillars'}
          </button>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950 font-extrabold text-xs shadow-lg flex items-center gap-1.5 cursor-pointer active:scale-95"
          >
            ...
            <div className="p-6 rounded-3xl bg-gradient-to-br from-blue-900/15 via-[#0a1026]/80 to-[#050A18] border border-white/10 backdrop-blur-md shadow-xl space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300">
                <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10">
                  <h5 className="font-bold text-white text-sm mb-1">54% Revenue Surge</h5>
                  <p>Surpassed global targets through recurring enterprise managed service contracts.</p>
                </div>
                <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10">
                  <h5 className="font-bold text-white text-sm mb-1">14 Flagship Accounts</h5>
                  <p>Onboarded premier corporate clients spanning FinTech, Logistics, and E-commerce.</p>
                </div>
              </div>
            </div>
            ...
            {topPerformerAward && (
              <div className="p-5 rounded-3xl bg-gradient-to-br from-amber-500/10 via-[#0a1026]/80 to-[#050A18] border border-amber-500/30 backdrop-blur-md shadow-xl flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400">Nominee pictures and winner suspense reveal.</p>
                </div>
                <button
